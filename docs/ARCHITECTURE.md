...
> 速查见 [`MODULE_BOUNDARIES.md`](./MODULE_BOUNDARIES.md)，分阶段迁移历史
> 见 [`MODULE_REFACTOR_PLAN.md`](./MODULE_REFACTOR_PLAN.md)，导入约束见
...
- 模块化重构全程实施记录（Phase 0–7）：`docs/MODULE_REFACTOR_PLAN.md`
