...
Moved out of ``app.services.scoring_service`` as part of Phase 3 step 4
of the module-refactor blueprint. The old module path remains as a
re-export shim through Phase 7 so existing imports
