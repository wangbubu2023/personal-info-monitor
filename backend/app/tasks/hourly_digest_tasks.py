...
1. Load the previous hour's context via
   :func:`app.services.hourly_digest.repository.build_digest_generation_context`.
...
4. Persist the final body via
   :func:`app.services.hourly_digest.repository.store_digest`.

All parsing / prompt / DB helpers live in ``app.services.hourly_digest``.
...
from app.services.hourly_digest.repository import (
    build_digest_generation_context,
    clear_hourly_digests,
    store_digest,
)
from app.services.hourly_digest.selection import (
...
from app.services.hourly_digest.synthesis import (
...
from app.services.hourly_digest import repository as _repository  # noqa: E402
from app.services.hourly_digest import selection as _selection  # noqa: E402
from app.services.hourly_digest import synthesis as _synthesis  # noqa: E402
from app.services.hourly_digest import text_utils as _text_utils  # noqa: E402
